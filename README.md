...
- MongoDB and Mongoose to save and retrieve data like staffs, orders and users
...
6. List Staffs
   ...
   2. add images
   3. render staffs
7. Create Staff Details
   1. create staff page
   2. create 3 columns
   3. show image in first column
   4. show staff info in second column
...
18. Seed sample staffs
    1. create staff model in mongoose
    2. insert sample staffs to mongodb
19. Load Staffs MongoDB
    1. load staffs in home page from mongodb
    2. load staffs in staff page from mongodb
    3. use staff api to check count in stock in add to cart
...
30. List Staffs For Admin
    1. create staffs page
    2. create staffs api
    3. use api in page
31. Create Staff Edit Page
    1. create edit page
    2. create api for staff
    3. show staff data in form
32. Upload Staff Image
    1. create cloudinary account
    2. get cloudinary keys
    3. create upload api
    4. upload files in edit page
33. Create And Delete Staffs
    1. add create staff button
    2. build new staff api
